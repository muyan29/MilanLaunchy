...
if __name__ == "__main__":
    ...
    loader, _ = read_file_bytes("loader.raw")
    write_at_offset("Custom_ld_Milan_bl_1008.bin",0x100,loader)
    ...
    copy_file("8036V206.ROM", "8036V206_MilanLaunchy.ROM")
    ...
    write_at_offset("8036V206_MilanLaunchy.ROM",0x10e0d00,bytes.fromhex(new_wpikek))
    write_at_offset("8036V206_MilanLaunchy.ROM",0x123a800,bytes.fromhex(new_wpikek))

    # replace PSP_FW_RECOVERY_BOOT_LOADER
    recbl, _ = read_file_bytes("Milan_rec_bl_1001.bin")
    write_at_offset("8036V206_MilanLaunchy.ROM",0x10a6900,recbl)
    
    # replace PSP_FW_BOOT_LOADER 
    cus_bl, _ = read_file_bytes("Custom_ld_Milan_bl_1008.bin")
    write_at_offset("8036V206_MilanLaunchy.ROM",0x11f6400,cus_bl)
